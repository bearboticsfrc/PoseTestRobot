...
public class Robot extends TimedRobot {
  ...
  public void teleopInit() {
    ...
    // if ( AutonomousCommandHelper.initialState != null ) {
    //
    // robotContainer.getDriveSubsystem().headingOffest(AutonomousCommandHelper.initialState.holonomicRotation.getDegrees());
    // }
  }
